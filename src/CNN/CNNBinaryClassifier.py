...
class CNNBinaryClassifier(nn.Module):
    ...
    ### N_channels should be adapted if the number of features changes

    def __init__(self, N_channels=58, sequence_length=128, conv_kernel_size=5, pool_kernel_size=2, 
